...
- `docsafe-field-validation-planner.html`: 把 regex、date bounds、real-time feedback、assistive entry 和 rejection review 转成可执行 validation policy brief 的 DocSafe 交互式小工具页
...
- `docsafe-field-validation-planner.js`: DocSafe regex、range、live feedback 和 review override 小工具的交互逻辑
